                        ...
                        <div class="column width-12">
                            <div class="row flex one-column-on-tablet">
                                <div class="column width-6 v-align-middle">
                                    <div>
                                        <h1 class="color-white">Drive with EasyTow</h1>
                                ...
                                <div class="column width-5 offset-1">
                                    <div class="signup-box box rounded xlarge mb-0 bkg-white shadow">
                                        ...
                                        <p class="mb-20">Already have an account? <a href="{{ url('/login') }}" class="fade-location">Click Here</a></p>
                                                ...
                                                <div class="row merged-form-elements">
                                                    <div class="column width-6">
                                                        <div class="field-wrapper">
                                                            ...
                                                            <input type="text" name="first_name" value="{{ old('first_name') }}" class="form-firstname form-element rounded medium" placeholder="John" required>
                                                    ...
                                                    <div class="column width-6">
                                                        <div class="field-wrapper">
                                                            ...
                                                            <input type="text" name="last_name" value="{{ old('last_name') }}" class="form-lastname form-element rounded medium" placeholder="Doe" required>
